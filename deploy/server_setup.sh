...
PROJECT_GIT_URL='https://github.com/eugenjamb/profiels_rest_api_django.git'
...
rm -s /etc/nginx/sites-available/profiles_api.conf /etc/nginx/sites-enabled/profiles_api.conf
